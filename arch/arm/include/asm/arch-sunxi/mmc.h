...
struct sunxi_mmc {
	...
	u32 cbda;		/* 0x94 */
	u32 res2[26];
#if defined(CONFIG_SUNXI_GEN_SUN6I) || defined(CONFIG_MACH_SUN50I_H6) || defined(CONFIG_MACH_SUN8IW16) || defined(CONFIG_MACH_SUN8IW19) || defined(CONFIG_MACH_SUN50IW9) || defined(CONFIG_MACH_SUN50IW10) || defined(CONFIG_MACH_SUN8IW15) || defined(CONFIG_MACH_SUN8IW7)
	u32 thld;	/* 0x100 */
